...
;;   Menlo (included with Mac OS X)

(defun color-theme-hoov ()
  (interactive)
  (color-theme-install
   '(color-theme-hoov
     ((background-color . "#000000")
      ...
      (mouse-color . "#660000"))
     (default ((t (:background "#000000" :foreground "#F6F3E8" :foundry "apple" :family "Menlo"))))
     ...
     (font-lock-builtin-face ((t (:foreground "#96CBFE" :italic t :slant italic))))
     ...
     (font-lock-variable-name-face ((t (:foreground "#C6C5FE" :bold t))))
